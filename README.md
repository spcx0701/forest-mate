...
<p align="center">
  <a href="https://github.com/spcx0701/forest-mate/actions/workflows/ci.yml">
    <img alt="CI" src="https://github.com/spcx0701/forest-mate/actions/workflows/ci.yml/badge.svg">
  </a>
...
ForestMate(숲길동무)는 산림 공공데이터와 AI 기반 안전 판단 로직을 활용해 **산행 전 코스 선택 → 산행 중 위험 감지·SOS → B2G 관제**까지 잇는 산행 안전 서비스입니다. 데모 목업이 아니라 **실제 백엔드(FastAPI) + 클라이언트(PWA·관제 웹)** 로 동작하며, 백엔드가 없으면 통신 음영지역을 대비해 자동으로 로컬 엔진으로 폴백합니다.
...
<p align="center">
  <img src="app/screens/home.png" alt="오늘의 산행지수" width="23%">
  <img src="app/screens/trail.png" alt="코스 상세 — 고도·위험 구간" width="23%">
  <img src="app/screens/ai.png" alt="AI 숲이 — 식물 식별" width="23%">
  <img src="app/screens/sos.png" alt="원터치 SOS" width="23%">
</p>
<p align="center"><sub>오늘의 산행지수 · 코스 상세(고도·위험 구간) · AI 숲이 · 원터치 SOS</sub></p>

<p align="center">
  <img src="app/screens/dashboard.png" alt="B2G 관제 대시보드" width="92%">
</p>
<p align="center"><sub>B2G 관제 대시보드 — 실시간 KPI · k-익명화 위험 히트맵 · WebSocket 피드</sub></p>
