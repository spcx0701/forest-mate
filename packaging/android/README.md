...
- 휴대폰 APK: `dist/forestmate-android-v1.4.4.apk`
- 워치 APK: `dist/forestmate-wear-v1.4.4.apk`
- 체크섬: 각 APK 옆의 `.sha256`
...
완료 후 signed release APK를 `dist/forestmate-android-v1.4.4.apk`와 `dist/forestmate-wear-v1.4.4.apk`로 복사해 함께 배포한다.
